...
def main():
    ...
    while True:
        choice = int(input("What would you like to do? 1:park 2: pay for parking 3: leave garage type 1,2,3! "))
        if choice ==1:
            garage.ticket()
        elif choice ==2:
            ticket_num = int(input("What was your ticket number?"))
            garage.paid_parking(ticket_num)
        elif choice ==3:
            
            ticket_num = int(input("What was your ticket number?"))
            garage.exit(ticket_num=)
            break
        else:
